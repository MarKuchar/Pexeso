...
class GameViewController: UIViewController {
    ...
    func setViews() {
        ...
        NSLayoutConstraint.activate([
            scoreImageView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 25),
            scoreImageView.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -5)])
        
        NSLayoutConstraint.activate([
            mistakeImageView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -25),
            mistakeImageView.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -5)])
    }
